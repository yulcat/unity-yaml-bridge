...
}
{
    ...
    try {
        ...
        assert(editedLeaf.prefabInstances[0].modifications.some(modification => modification.propertyPath === 'm_Name' && modification.value === 'LeafDirectRename' &&
            ...
            modification.target.guid === middleGuid) && editedLeaf.prefabInstances[0].modifications.some(modification => modification.propertyPath === 'm_Enabled' && modification.value === '0' &&
